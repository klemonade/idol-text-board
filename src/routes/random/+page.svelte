...
<section class="flex flex-col items-center justify-center pt-16 gap-4">
    <p>Participant</p>
    <textarea name="" id="" cols="30" rows="10" class="text-black" bind:value={participantText}></textarea>
    ...
    <div class="w-[50%]">
        {#if showRealWinner}
            ...
            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400 border-2 border-r-2 rounded border-gray-500">
